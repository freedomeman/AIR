...
void Task_start(void) {
    ...
    //xTaskCreate(ins_task, "ins_task", Huge_Stack_Size, NULL, PriorityHigh, &ins_task_handle);

    xTaskCreate(gimbal_task, "gimbal_task", Normal_Stack_Size, NULL, PriorityRealtime, &gimbal_task_handle);
