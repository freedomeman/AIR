...
{
    imu_can.angle[0] = ((fp32)((int32_t)((rx_data[0]<<24) | (rx_data[1]<<16) | (rx_data[2]<<8) | rx_data[3])))/100000000;
    imu_can.angle[1] = ((fp32)((int32_t)((rx_data[4]<<24) | (rx_data[5]<<16) | (rx_data[6]<<8) | rx_data[7])))/100000000;
    // imu_can.angle[2] = ((fp32)((int16_t)((rx_data[4]<<8)|rx_data[5])))/1000;
	// imu_can.angle[3] = ((fp32)((int16_t)((rx_data[6]<<8)|rx_data[7])))/1000;
}
